  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white px-4 py-12">
      ...
      <div className="max-w-5xl mx-auto text-center">
        ...
        <p className="text-lg text-gray-400 mb-12 ">We would love to hear from you. Feel free to reach out!</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="flex flex-col justify-center bg-gray-800 p-8 rounded-lg shadow-lg">
            ...
            <div className="flex items-center mb-8">
              ...
              <span>naval colony, City:karachi, pakistan... </span>
            </div>

            {/* Social Media Links */}
            <div className="flex justify-center space-x-4">
             
              <Link href="https://www.linkedin.com/in/arisha-saleem-7a81742b7?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" target="_blank" className="text-teal-500 hover:text-teal-400">
                <FiLinkedin size={24} />
              </Link>
              <Link href="https://github.com/Arishasaleem" target="_blank" className="text-teal-500 hover:text-teal-400">
                <FiGithub size={24} />
              </Link>
            </div>
            <Meteors number={20} />
